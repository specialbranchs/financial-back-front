                        ...
                        >
                            ...
                            <TableBody >
                                ...
                                <TableRow>
                                    ...
                                    <TableCell align="right" sx={sxStyle}>{person.name}</TableCell>
                                </TableRow>
                                <TableRow >
                                    <TableCell sx={sxStyle}>পিতার নাম</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.fatherName}</TableCell>
                                </TableRow>
                                <TableRow>
                                ...
                                <TableRow>
                                    ...
                                    <TableCell align="right" sx={sxStyle}>{person.nid}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={sxStyle}>টিআইএন নম্বর</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.tinNumber}</TableCell>
                                </TableRow>
                                ...
                                <TableRow>
                                    ...
                                    <TableCell align="right" sx={sxStyle}>{person.personal[0].presentAdd}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={sxStyle}>জন্ম তারিখ</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.personal[0].dateOfBirth}</TableCell>
                                </TableRow>

                                <TableRow>
                                    <TableCell sx={sxStyle}>জন্মস্থান</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.personal[0].birthPlace}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={sxStyle}>উচ্চতা</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.personal[0].height}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={sxStyle}>দেহ রং</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.personal[0].bodyColor}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={sxStyle}>সনাক্ত করন</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.personal[0].clue}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={sxStyle}>ধর্ম</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.personal[0].religion}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={sxStyle}>টেলিফোন/মোবাইল নম্বর</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.personal[0].mobile}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={sxStyle}>পাসপোর্ট নম্বর ও ইস্যুর তারিখ</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.personal[0].passport}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={sxStyle}>শিক্ষাগত যোগ্যতা</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.personal[0].education}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={sxStyle}>পারিবারিক বৃত্তান্ত</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.personal[0].family}</TableCell>
                                </TableRow>
                                <TableRow>
                                    ...
                                    <TableCell align="right" sx={sxStyle}>{person.professional[0].profession}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={sxStyle}>বাৎসরিক আয়</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.professional[0].income}</TableCell>
                                </TableRow>
                                <TableRow>
                                    ...
                                    <TableCell align="right" sx={sxStyle}>{person.professional[0].business}</TableCell>
                                </TableRow>
                                <TableRow>
                                    ...
                                    <TableCell align="right" sx={sxStyle}>{person.political[0].politicalInfo}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={sxStyle}>মামলার বিবরন (সাজাপ্রাপ্ত কিনা ? / সাজাপ্রাপ্ত হলে পাঁচ বৎসর অতিক্রান্ত হয়েছে কিনা ?)</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.mamla[0].mamlaInfo}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={sxStyle}>চরমপান্থি , জঙ্গীবাদ , রাষ্ট্রদ্রোহীবা নাশকতামূলক কর্মকান্ডে জড়িত থাকলে তার বিবরন</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.mamla[0].sabotageInfo}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={sxStyle}>আটকাদেশ থাকলে তার বিবরন</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.mamla[0].arrestOrder}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={sxStyle}>গ্রেফতার সম্পর্কিত তথ্য</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.mamla[0].arrestInfo}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={sxStyle}>সম্পদের বিবরন</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.personal[0].wealth}</TableCell>
                                </TableRow>
                                <TableRow>
                                    ...
                                    <TableCell align="right" sx={sxStyle}>{person.professional[0].contribution}</TableCell>
                                </TableRow>
                                <TableRow>
                                    ...
                                    <TableCell align="right" sx={sxStyle}>{person.political[0].electionInfo}</TableCell>
                                </TableRow>

                                <TableRow>
                                    <TableCell sx={sxStyle}>দুর্নীতি সংক্রান্ত তথ্যাদি</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.mamla[0].corruptionInfo}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={sxStyle}>থানা / ডিএসবির রেকর্ড</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.mamla[0].thanaRecord}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={sxStyle}>স্থানীয় প্রভাব</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.mamla[0].influential}</TableCell>
                                </TableRow>
                                <TableRow>
                                    <TableCell sx={sxStyle}>বিবিধ|মতামত</TableCell>
                                    <TableCell align="right" sx={sxStyle}>{person.evaluation[0].evaluation}</TableCell>
                                </TableRow>
