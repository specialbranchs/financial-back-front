...
const PersonScreen = () => {
  ...
  const refreshBtn = () => {
    if (
      searchData.name === "" &&
      searchData.fatherName === "" &&
      searchData.tinNumber === "" &&
      searchData.podok === 0 &&
      searchData.child === 0 &&
      searchData.podokpost === "" &&
      searchData.nid === "" &&
  ...
  return (
    <>
            ...
            <DatePicker
              ...
              onChange={(newValue: Dayjs | null) => {
                if (newValue) {
                  setSearchData({
                    ...searchData,
                    start: new Date(newValue.add(1, "day").toDate())
                      .toISOString()
                      .slice(0, 10),
                  });
                }
            ...
            <DatePicker
              ...
              onChange={(newValue: Dayjs | null) => {
                if (newValue) {
                  setSearchData({
                    ...searchData,
                    end: new Date(newValue.add(1, "day").toDate())
                      .toISOString()
                      .slice(0, 10),
                  });
                }
      ...
      {personList.length == 0 ? (
        ...
        >
          <Typography sx={sxStyle}>Data not found</Typography>
        </Toolbar>
      ) : (
        <PersonTable
