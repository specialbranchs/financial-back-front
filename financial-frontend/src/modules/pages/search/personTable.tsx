...
import PersonBtn, { sxStyle } from "./editsearch/PersonDetails";
    ...
    <>
      <TableContainer component={Paper}>
        ...
        >
          <TableHead>
            <TableRow>
              <TableCell sx={sxStyle} align="center" colSpan={3}>
                বিস্তারিত
              </TableCell>
            </TableRow>
          </TableHead>
              ...
              .map((value, index) => (
                <>
                  ...
                  <TableRow>
                    ...
                    <TableCell align="right" sx={sxStyle}>
                      {value.name}
                    </TableCell>
                  </TableRow>
                  <TableRow>
